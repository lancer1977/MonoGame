# MonoGame portfolio roadmap

## 90-day evidence snapshot
- Commits (90 days): 4
- Files changed (90 days): 24
- Last signal: ed784ab (4 days ago)
- Top modified areas: docs(9);00_agile(6);tests(5);src(2);PolyhydraGames.MonoGame.sln(1);.gitattributes(1)
- Notes: clean_at_scan
